    ...
    class Game:
        ...
        def spawn_cactus(self):
            ...
            for i in range(num_cacti):
                ...
                correct_index = random.randint(0, num_cacti - 1)
                ...
                if i == correct_index:
                    ...
                    while True:
                        incorrect = random.randint(self.question.answer - 4, self.question.answer + 4)
                        if incorrect >= 0:
                            value = incorrect
                            break
                    ...
                    for cactus in game.obstacles:
                        ...
                        if game.collision.between(dino, cactus):
                            if cactus.value == game.question.answer:
                                game.obstacles.remove(cactus)  # Remove only correct cactus
                                game.score.act += 10  # Increase score
